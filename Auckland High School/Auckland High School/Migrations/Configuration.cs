namespace Auckland_High_School.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Auckland_High_School.Models.SchoolDBContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "Auckland_High_School.Models.SchoolDBContext";
        }

        protected override void Seed(Auckland_High_School.Models.SchoolDBContext context)
        {
