namespace WebBlog.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebBlog.Models.WebBlogDBContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "WebBlog.Models.WebBlogDBContext";
        }

        protected override void Seed(WebBlog.Models.WebBlogDBContext context)
        {
